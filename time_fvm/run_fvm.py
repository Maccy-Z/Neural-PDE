...
# def FVM_transonic_ellipses(cfg: ConfigFVM):
#     N_comp = 4
...
def init_conds(mesh: FVMMesh, edge_tag, bound_edgs, cfg: ConfigFVM,
...
def main():
    ...
    if new_mesh:
        ...
        prob_definition = FVM_nozzle(cfg)
    ...
    bc_tags, us_init = init_conds(mesh, edge_tag, bound_edgs, cfg, vx=V_x_nat, rho=rho_nat, T=T_nat)
